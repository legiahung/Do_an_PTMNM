...
<body>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        ...
        <h4 class="text-light">ID hóa đơn: <?= $id_hd; ?></h4>
        <h4 class="text-light">Họ : <?= $firstname; ?></h4>
        <h4 class="text-light">Tên: <?= $lastname; ?></h4>
        <h4 class="text-light">Tên sản phẩm: <?= $tents; ?></h4>
        <h4 class="text-light">Địa chỉ : <?= $diachi; ?></h4>
        <h4 class="text-light">Số điện thoại: <?= $sdt; ?></h4>
        <h4 class="text-light">Mô tả: <?= $mota; ?></h4>
        <h4 class="text-light">Số lượng: <?= $soluong; ?></h4>
        <h4 class="text-light">Gía: <?= $gia; ?></h4>
        <h4 class="text-light">Tổng tiền: <?= $tongtien; ?></h4>
        <h4 class="text-light">Tình trạng: <?= $tinhtrang; ?></h4>
      </div>
    </div>
  </div>
    </body>
