...
<body>
    <?php
        if (isset($_POST['submit'])) {
            $bd = $_POST['batdau'];
            $kt = $_POST['ketthuc'];
            if (($bd < 10 && $kt < 10) || ($bd >= 17 && $kt < 17)) {
                $mgs = "Đang trong thời gian nghỉ, máy chủ tạm không hoạt động";
            }else{
...
<form action="" method="post">
    <table align="center" bgcolor="#00CC99">
        <tr>
            <td colspan="2" bgcolor="#009999"><h1>TÍNH TIỀN KARAOKE</h1></td>
        </tr>
        <tr>
            <td>Giờ bắt đầu: </td>
        ...
        <tr>
            ...
            <td> <input type="text" name="thanhtoan" style="background-color: #FFFFCC;" readonly value="<?php if (isset($ket_qua)) echo $ket_qua;?>">(VNĐ)</td>
        </tr>
        <tr>
