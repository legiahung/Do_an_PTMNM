      ...
      <div class="col-md-4">
        ...
        <form action="action_NV.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <input type="text" name="id_emp" value="<?= $id_emp; ?>" class="form-control" placeholder="Nhập ID nhân viên" required>
          </div>
          <div class="form-group">
...
<tbody>
  ...
  <tr>
    ...
    <td><?= $row['QUYEN']; ?></td>
    <td>
      <a href="details_NV.php?details=<?= $row['ID_USER']; ?>" class="badge badge-primary p-2">Xem chi tiết</a> |
      <a href="action_NV.php?delete=<?= $row['ID_USER']; ?>" class="badge badge-danger p-2" onclick="return confirm('Bạn có chắc là muốn xóa?');">Xóa</a> |
      <a href="info_NV.php?edit=<?= $row['ID_USER']; ?>" class="badge badge-success p-2">Chỉnh sửa</a>
    </td>
  </tr>
  <?php } ?>
</tbody>
