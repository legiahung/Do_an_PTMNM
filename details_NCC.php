...
<body>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        ...
        <h4 class="text-light">Tên NCC : <?= $vtenncc ; ?></h4>
        <h4 class="text-light">Email NCC : <?= $vemailncc  ; ?></h4>
        <h4 class="text-light">Địa chỉ NCC : <?= $vaddncc ; ?></h4>
        <h4 class="text-light">SĐT NCC: <?= $phonencc ; ?></h4>
      </div>
    </div>
  </div>
    </body>
